...
-------------------------------------
        ...
        +======================================+=================================================+==================================================+=========+
        |CONFIG_SPI                            | SPI使能配置                                     | ``middleware\soc\bk7258_ap\bk7258_ap.defconfig`` |    y    |
        +--------------------------------------+-------------------------------------------------+--------------------------------------------------+---------+
        |CONFIG_SPI_DMA                        | SPI使能DMA配置                                  | ``middleware\soc\bk7258_ap\bk7258_ap.defconfig`` |    y    |
        +--------------------------------------+-------------------------------------------------+--------------------------------------------------+---------+
        |CONFIG_SPI_STATIS                     | SPI DEBUG使能，用于命令行dump spi寄存器信息     | ``middleware\soc\bk7258_ap\bk7258_ap.defconfig`` |    y    |
        +--------------------------------------+-------------------------------------------------+--------------------------------------------------+---------+
        |CONFIG_SPI_SUPPORT_TX_FIFO_WR_READY   | SPI使能TX Fifo中断检测配置，一般建议使能        | ``middleware\soc\bk7258_ap\bk7258_ap.defconfig`` |    y    |
        +--------------------------------------+-------------------------------------------------+--------------------------------------------------+---------+
        |CONFIG_SPI_PM_CB_SUPPORT              | SPI使能低功耗投票功能                           | ``middleware\soc\bk7258_ap\bk7258_ap.defconfig`` |    n    |
        +--------------------------------------+-------------------------------------------------+--------------------------------------------------+---------+
        |CONFIG_SPI_MST_FLASH                  | SPI flash使能配置                               | ``middleware\soc\bk7258_ap\bk7258_ap.defconfig`` |    n    |
        +--------------------------------------+-------------------------------------------------+--------------------------------------------------+---------+
